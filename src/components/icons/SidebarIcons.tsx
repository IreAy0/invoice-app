...
export function GettingStartedIcon({ className }: SidebarIconProps) {
  return (
    <svg
      className={className}
      width="24"
...
export function OverviewIcon({ className }: SidebarIconProps) {
  return (
    <svg
      className={className}
      width="24"
...
export function AccountsIcon({ className }: SidebarIconProps) {
  return (
    <svg
      className={className}
      width="24"
...
export function InvoiceIcon({ className }: SidebarIconProps) {
  return (
    <svg
      className={className}
      width="24"
...
export function BeneficiaryIcon({ className }: SidebarIconProps) {
  return (
    <svg
      className={className}
      width="24"
...
export function HelpCenterIcon({ className }: SidebarIconProps) {
  return (
    <svg
      className={className}
      width="24"
...
export function SettingsIcon({ className }: SidebarIconProps) {
  return (
    <svg
      className={className}
      width="24"
...
export function MoneyIcon({ className }: SidebarIconProps) {
  return (
    <svg
      className={className}
      width="80"
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <rect width="80" height="80" fill="url(#pattern0_1_7439)" />
      <defs>
        <pattern
          id="pattern0_1_7439"
          ...
          height="1"
        >
          <use transform="scale(0.00222222)" />
        </pattern>
      </defs>
    </svg>
  );
